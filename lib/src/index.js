...
class VerdaccioMiddlewarePlugin {
    ...
    register_middlewares(app) {
        ...
        try {
            ...
            this.client.connect();
            router.get("/all", (request, response) => __awaiter(this, void 0, void 0, function* () {
                let res = yield this.client.query("SELECT * FROM publish");
                response.status(200).json(res.rows);
            }));
            router.get("/(@:scope/)?:packageName/:version", (request, response, next) => __awaiter(this, void 0, void 0, function* () {
